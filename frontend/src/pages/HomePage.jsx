  ...
  return (
    <div className="h-screen bg-base-200">
      <div className="flex items-center justify-center md:pt-20 px-0 sm:px-4 h-screen md:h-auto">
        <div className="bg-base-100 rounded-lg shadow-xl w-full max-w-full md:max-w-4xl lg:max-w-6xl h-screen md:h-[calc(100vh-8rem)] min-h-screen md:min-h-0">
          {/* Desktop (md+) layout: sidebar + chat */}
          <div className="hidden md:flex h-full rounded-lg overflow-hidden md:gap-6">
            <Sidebar />
